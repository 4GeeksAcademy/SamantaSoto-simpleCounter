...
const Home = ( {seconds} ) => {
	...
	return (
		<div className="row text-center text-bg-dark p-3 m-2 grid gap-3 fw-bold">
			...
			<div className="col align-middle digit fs-1 fw-bold bg-dark bg-gradient me-5 rounded-2 px-0 py-3 border border-4 border-top-0 border-bottom-0">{digit[0]}</div>
		</div>
	);
};
